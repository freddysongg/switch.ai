    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] mx-auto px-4 text-center w-full">
      <div className="w-full max-w-3xl">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground mb-12 lowercase">gpt, but for switches...</p>

          <div className="relative w-full max-w-2xl mx-auto">
            <Textarea
              placeholder="i'm looking for a switch that..."
              className="min-h-[60px] pr-12 bg-card/50 border-0 focus-visible:ring-1 focus-visible:ring-primary resize-none"
              disabled={isLoading}
              onKeyDown={(e) => {
